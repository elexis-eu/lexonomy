...
Download.render=function(div, json){
  ...
  $div.append("<div i18n class='title'>XSLT transformation on download</div>");
  ...
  $div.append("<div i18n class='instro'>You can use this functionality to automatically apply an XSLT transformation when the dictionary is downloaded. If you do not input valid XSLT here, no transformation will be applied.</div>");
};
