...
Thes.render=function(div, json){
  ...
  var $block=$("<div class='block container'></div>").appendTo($div);
	$block.append("<div class='title'>Thesaurus item container</div>");
  ...
  $block.append("<div class='instro'>Select the element which should wrap each individual thesaurus item (a word). When you pull thesaurus items automatically from a corpus, Lexonomy will insert one of these elements for each thesaurus item.</div>");
  ...
  $block.append("<div class='instro'>This is the XML that will be inserted into your entries with each thesaurus item. The actual text will be where the placeholder <code>$text</code> is.</div>");
