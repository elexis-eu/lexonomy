...
Thes.render=function(div, json){
  ...
  var $block=$("<div class='block container'></div>").appendTo($div);
	$block.append("<div class='title'>Related word container</div>");
  ...
  $block.append("<div class='instro'>Select the element which should wrap each individual related word. When you pull related words automatically from a corpus, Lexonomy will insert one of these elements for each related word.</div>");
  ...
  $block.append("<div class='instro'>This is the XML that will be inserted into your entries with each related word. The actual text will be where the placeholder <code>$text</code> is.</div>");
