...
Defo.render=function(div, json){
  ...
  var $block=$("<div class='block container'></div>").appendTo($div);
	$block.append("<div class='title'>Definition container</div>");
  ...
  $block.append("<div class='instro'>Select the element which should wrap each definition. When you pull definitions automatically from a corpus, Lexonomy will insert one of these elements for each definition.</div>");
  ...
  $block.append("<div class='instro'>This is the XML that will be inserted into your entries with each Definition. The actual text will be where the placeholder <code>$text</code> is.</div>");
