...
Searchability.render=function(div, json){
  ...
  var $block=$("<div class='block searchableElements'></div>").appendTo($div);
	$block.append("<div class='title'>Searchable elements</div>");
  ...
  $block.append("<div class='instro'>The contents of elements you select here will be searchable (in addition to each entry's headword).</div>");
