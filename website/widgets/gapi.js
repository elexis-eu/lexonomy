...
Gapi.render=function(div, json){
  ...
  $div.append("<hr>");
  $div.append("<div class='title'>Auto download images to each entry</div>");
  $div.append("<div class='instro borderBelow'>If you want to add images to each entry automatically, Lexonomy can do that for you. First, go to Entry structure and add element with content type <i>media</i>. When you're ready, select element and number of images you want to add. </div>");
