...
Oneclick.renderKey=function(apikey){
  ...
  $div.append("<div i18n class='title'>One-Click Dictionary API key</div>");
  $div.append("<div i18n class='instro'>This key allows external tools such as Sketch Engine to create a dictionary in your account and to populate it with pre-generated entries.</div>");
  if(!apikey){
