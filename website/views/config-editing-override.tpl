...
<html>
    ...
    <body>
         %include("header.tpl", i18n=i18n,user=user, dictID=dictID, dictTitle=dictTitle, current="config", configTitle=i18n["Entry editor"], configUrl="editing-override", rootPath="../../../")
    </body>
</html>
