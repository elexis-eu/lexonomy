...
<html>
	...
	var dictID="{{dictID}}";
        ...
        Screenful.Editor.entryID="kontext";
        ...
        Screenful.Editor.editor=function(div, entry){
            Kontext.change=Screenful.Editor.changed;
            Kontext.render(div, entry.content);
        };
        Screenful.Editor.harvester=function(div){
            return JSON.stringify(Kontext.harvest(div));
        };
    ...
    <body>
                %include("header.tpl", user=user, dictID=dictID, dictTitle=dictTitle, current="config", configTitle="KonText connection", configUrl="kontext", rootPath="../../../")
    </body>
</html>
