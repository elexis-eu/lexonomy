...
<html>
    ...
    <link type="text/css" rel="stylesheet" href="../../../libs/screenful/screenful.css" />
		...
		Screenful.Editor.editor=function(div, entry){
			Defo.change=Screenful.Editor.changed;
			Defo.render(div, entry.content);
		};
		Screenful.Editor.harvester=function(div){
			return JSON.stringify(Defo.harvest(div));
		};
	...
	<body>
                %include("header.tpl", user=user, dictID=dictID, dictTitle=dictTitle, current="config", configTitle="Definitions", configUrl="defo", rootPath="../../../")
	</body>
</html>
