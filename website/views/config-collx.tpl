...
<html>
    ...
    <link type="text/css" rel="stylesheet" href="../../../libs/screenful/screenful.css" />
		...
		<script type="text/javascript" src="../../../widgets/collx.js"></script>
		...
		Screenful.Editor.entryID="collx";
		...
		Screenful.Editor.editor=function(div, entry){
			Collx.change=Screenful.Editor.changed;
			Collx.render(div, entry.content);
		};
		Screenful.Editor.harvester=function(div){
			return JSON.stringify(Collx.harvest(div));
		};
	...
	<body>
                %include("header.tpl", i18n=i18n,user=user, dictID=dictID, dictTitle=dictTitle, current="config", configTitle=i18n["Collocations"], configUrl="collx", rootPath="../../../")
	</body>
</html>
