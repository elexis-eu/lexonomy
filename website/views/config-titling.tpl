...
<html>
    ...
    <link type="text/css" rel="stylesheet" href="../../../libs/screenful/screenful.css" />
		...
		Screenful.Editor.editor=function(div, entry){
			Titling.change=Screenful.Editor.changed;
			Titling.render(div, entry.content);
		};
		Screenful.Editor.harvester=function(div){
			return JSON.stringify(Titling.harvest(div));
		};
	...
	<body>
                %include("header.tpl", i18n=i18n,user=user, dictID=dictID, dictTitle=dictTitle, current="config", configTitle=i18n["Headwords"], configUrl="titling", rootPath="../../../")
	</body>
</html>
