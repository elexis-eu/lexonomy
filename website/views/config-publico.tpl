...
<html>
    ...
    <link type="text/css" rel="stylesheet" href="../../../libs/screenful/screenful.css" />
		...
		<script type="text/javascript" src="../../../widgets/publico.js"></script>
		...
		Screenful.Editor.entryID="publico";
		...
		Screenful.Editor.editor=function(div, entry){
			Publico.change=Screenful.Editor.changed;
			Publico.render(div, entry.content);
		};
		Screenful.Editor.harvester=function(div){
			return JSON.stringify(Publico.harvest(div));
		};
	...
	<body>
                %include("header.tpl", i18n=i18n,user=user, dictID=dictID, dictTitle=dictTitle, current="config", configTitle=i18n["Public access"], configUrl="publico", rootPath="../../../")
	</body>
</html>
