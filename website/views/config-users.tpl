...
<html>
    ...
    <link type="text/css" rel="stylesheet" href="../../../libs/screenful/screenful.css" />
		...
		Screenful.Editor.editor=function(div, entry){
			Users.change=Screenful.Editor.changed;
			Users.render(div, entry.content);
		};
		Screenful.Editor.harvester=function(div){
			return JSON.stringify(Users.harvest(div));
		};
	...
	<body>
                %include("header.tpl", i18n=i18n,user=user, dictID=dictID, dictTitle=dictTitle, current="config", configTitle=i18n["Users"], configUrl="users", rootPath="../../../")
	</body>
</html>
