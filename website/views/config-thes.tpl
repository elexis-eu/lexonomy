...
<html>
    ...
    <link type="text/css" rel="stylesheet" href="../../../libs/screenful/screenful.css" />
		...
		<script type="text/javascript" src="../../../widgets/thes.js"></script>
		...
		Screenful.Editor.editor=function(div, entry){
			Thes.change=Screenful.Editor.changed;
			Thes.render(div, entry.content);
		};
		Screenful.Editor.harvester=function(div){
			return JSON.stringify(Thes.harvest(div));
		};
	...
	<body>
                %include("header.tpl", i18n=i18n,user=user, dictID=dictID, dictTitle=dictTitle, current="config", configTitle=i18n["Thesaurus items"], configUrl="thes", rootPath="../../../")
	</body>
</html>
