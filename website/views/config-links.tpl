...
<html>
    ...
    <link type="text/css" rel="stylesheet" href="../../../libs/screenful/screenful.css" />
		...
		<script type="text/javascript" src="../../../widgets/links.js"></script>
		...
		Screenful.Editor.entryID="links";
		...
		Screenful.Editor.editor=function(div, entry){
			Links.change=Screenful.Editor.changed;
			Links.render(div, entry.content);
		};
	...
	<body>
                %include("header.tpl", i18n=i18n,user=user, dictID=dictID, dictTitle=dictTitle, current="config", configTitle=i18n["Linking"], configUrl="links", rootPath="../../../")
	</body>
</html>
