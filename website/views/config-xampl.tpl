...
<html>
    ...
    <link type="text/css" rel="stylesheet" href="../../../libs/screenful/screenful.css" />
		...
		<script type="text/javascript" src="../../../widgets/xampl.js"></script>
		...
		Screenful.Editor.entryID="xampl";
		...
		Screenful.Editor.editor=function(div, entry){
			Xampl.change=Screenful.Editor.changed;
			Xampl.render(div, entry.content);
		};
		Screenful.Editor.harvester=function(div){
			return JSON.stringify(Xampl.harvest(div));
		};
	...
	<body>
                %include("header.tpl", i18n=i18n,user=user, dictID=dictID, dictTitle=dictTitle, current="config", configTitle=i18n["Examples"], configUrl="xampl", rootPath="../../../")
	</body>
</html>
