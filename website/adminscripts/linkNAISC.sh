...
JOBID="$5"
CURRDIR=`dirname $0`
python3 $CURRDIR/xml2ontolex.py $DATADIR/dicts/$DB1.sqlite > /tmp/linkNAISC-$DB1.nt
python3 $CURRDIR/xml2ontolex.py $DATADIR/dicts/$DB2.sqlite > /tmp/linkNAISC-$DB2.nt
